...
<!-- Mirrored from themesbrand.com/velzon/html/material/auth-signin-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Aug 2024 20:03:46 GMT -->
<head>
                                        ...
                                        <div class="mt-4">
                                            <form action="{{ route('login_post') }}" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" name="email" value="{{ old('email') }}" class="form-control" id="useremail" placeholder="Enter email address" required>
                                                    @error('email')
