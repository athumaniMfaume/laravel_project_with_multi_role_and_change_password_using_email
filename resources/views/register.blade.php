                                        ...
                                        <div class="mt-4">
                                            <form action="{{route("register_post")}}" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" name="email" value="{{ old('email') }}" class="form-control" id="useremail" placeholder="Enter email address">
                                                    @error('email')
                                                        <p class="text-danger">{{$message}}</p>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="role" id="" class="form-control">
                                                        ...
                                                        <option {{ old('role') == '2' ? 'selected' : '' }} value="2">Super Admin</option>
