                            ...
                            <div class="row justify-content-center g-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="p-2">
                                            <form action="{{url('reset_password_post/'.$token)}}" method="POST">
                                                @csrf
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup mb-3">
                                                        <input type="password" name="password_confirmation" class="form-control pe-5 password-input"  placeholder="Confirm password"  >
